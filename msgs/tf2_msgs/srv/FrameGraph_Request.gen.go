...
// FrameGraph_Request
func NewFrameGraph_RequestPublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*FrameGraph_RequestPublisher, error) {
	pub, err := node.NewPublisher(topic_name, FrameGraph_RequestTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// FrameGraph_Request
func NewFrameGraph_RequestSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback FrameGraph_RequestSubscriptionCallback) (*FrameGraph_RequestSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg FrameGraph_Request
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topic_name, FrameGraph_RequestTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
